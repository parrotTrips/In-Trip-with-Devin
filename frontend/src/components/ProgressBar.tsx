import { getProgressPercentage, currentUserPhaseId, parrotPhaseId } from '../data/tripData';
  ...
  return (
    <div className="px-4 py-3">
      <div className="flex items-center justify-between mb-1.5">
        <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Trip Progress</span>
        <span className={`text-xs font-bold ${isBehind ? 'text-amber-600' : 'text-emerald-600'}`}>
          {userProgress}%
        </span>
      </div>
      <div className="relative h-3 bg-gray-100 rounded-full overflow-hidden">
        {/* Parrot target indicator */}
        <div
