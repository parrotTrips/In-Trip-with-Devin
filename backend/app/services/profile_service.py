...
async def update_profile(
    ...
    if "dietary_restrictions_yn" in update_data:
        profile.dietary_restrictions_flag = _decode_yes_no(update_data["dietary_restrictions_yn"])
    ...
    if "passport_issue_date" in update_data:
        profile.passport_issue_date = _parse_optional_date(update_data["passport_issue_date"])
    if "passport_expiration_date" in update_data:
        profile.passport_expiration_date = _parse_optional_date(update_data["passport_expiration_date"])
    ...
    if "intl_flights_help_yn" in update_data:
        profile.needs_flight_help_flag = _decode_yes_no(update_data["intl_flights_help_yn"])
    ...
    if "travel_insurance_help_yn" in update_data:
        profile.needs_travel_insurance_help_flag = _decode_yes_no(update_data["travel_insurance_help_yn"])
