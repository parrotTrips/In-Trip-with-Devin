...
class ProfileUpdate(BaseModel):
    ...
    travel_insurance_status: Optional[str] = None
    travel_insurance_brazil_medical_coverage: Optional[str] = None
    travel_insurance_provider: Optional[str] = None
    travel_insurance_policy_number: Optional[str] = None
    travel_insurance_notes: Optional[str] = None
    roommate_status: Optional[str] = None
    roommate_email: Optional[str] = None
    room_configuration: Optional[str] = None
    roommate_gender_preference: Optional[str] = None
    extended_stay_help: Optional[str] = None
    extended_stay_help_details: Optional[str] = None
    early_check_in_preference: Optional[str] = None
    emergency_contact: Optional[str] = None
    instagram_handle: Optional[str] = None
    trip_mood: Optional[str] = None
    social_topic: Optional[str] = None
    always_up_for: Optional[str] = None
    home_address: Optional[str] = None
    final_considerations: Optional[str] = None
